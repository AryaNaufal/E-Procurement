...
class TimelineService
{
  ...
  public function insertPendaftaran(string $participantId, string $tenderId, string $date)
  {
    $sql = "INSERT INTO timeline_pengadaan (participant_id, tender_id, awal_pendaftaran) VALUES (:participant_id, :tender_id, :date)";
    try {
