...
?>
<form method="GET" action="tender.php">
  <div class="box-select">
    <div>
      <select name="category" class="select-category">
        ...
        <option <?= $category == 'barang_jasa' ? 'selected' : '' ?> value="barang_jasa">Pengadaan Barang &amp; Jasa</option>
        <option <?= $category == 'jasa_konsultasi' ? 'selected' : '' ?> value="jasa_konsultasi">Jasa Konsultasi Bidang Usaha</option>
      </select>
    </div>
    <div class="select">
      <div class="form-box fix">
        <input style="height: 45px;" type="text" name="keyword" placeholder="Keyword"
