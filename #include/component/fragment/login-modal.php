        ...
        <div class="modal-body">
          <div class="form-pop-up-content ptb-30 pl-60 pr-60">
            ...
            <form method="post" id="form_login" autocomplete="off">
              ...
              <!-- <a href="#" data-toggle="modal" data-target="#ResetPwdModal" onclick="$('#LoginModal').modal('hide');" style="cursor:pointer; color:#0091ff; font-size: 12px;">Forgot Password ?</a> -->
              <a style="cursor:pointer;" data-toggle="modal" data-target="#ResetPwdModal">Forgot Password ?</a>
