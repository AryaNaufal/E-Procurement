<!-- Start Blog
    ============================================= -->
<div class="blog-area single" style="min-height: calc(100vh - 150px);">
        ...
        <div class="blog-content col-lg-8 col-md-12">
          <div class="item">
            <div class="blog-item-box">
              <div class="thumb">
                ...
                <div class="date"><strong><?= date('d', strtotime($newsData['created_at'])) ?></strong> <span><?= date('M', strtotime($newsData['created_at'])) ?></span></div>
              </div>
              <div class="info">
                <h4>
                  <a href="#" title="<?= $newsData['judul'] ?>"><?= $newsData['judul'] ?></a>
                </h4>
                <div class="content">
                  <p><?= $newsData['isi'] ?></p>
                </div>
          ...
          <div class="post-pagi-area pb-5 px-3">
            ...
            <?php if (isset($previousNews)): ?>
              <a href="<?= SERVER_NAME . "news/" . $Lib->seo_title($previousNews['judul']); ?>" style="max-width: 200px;">
            ...
            <div class="sidebar-item recent-post">
              ...
              <ul>
                <?php foreach (array_slice($news['data'], -3) as $newsItem): ?>
                  <li>
                    <div class="thumb">
                      <a href="<?= SERVER_NAME . "news/" . $Lib->seo_title($newsItem['judul']); ?>">
                        <img src="<?= SERVER_NAME . 'assets/management/images/news/' . $newsItem['gambar'] ?>" alt="Thumb">
                      </a>
                    </div>
                    <div class="info">
                      <div class="meta-title">
                        <span class="post-date"><?= date('d-m-Y', strtotime($newsItem['created_at'])); ?></span>
                      </div>
                      <a href="<?= SERVER_NAME . "news/" . $Lib->seo_title($newsItem['judul']); ?>" title="<?= $newsItem['judul'] ?>"><?= $newsItem['judul'] ?></a>
                    </div>
                  </li>
                <?php endforeach; ?>
              </ul>
